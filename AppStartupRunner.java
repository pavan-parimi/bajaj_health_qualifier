package com.pavan.bajaj_health_qualifiertest;
...
public class AppStartupRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        com.usman.bajaj_health_qualifier.GenerateWebhookResponse webhookResponse = generateWebhook();
    ...
    private com.usman.bajaj_health_qualifier.GenerateWebhookResponse generateWebhook() {
        String url = "https://bfhldevapigw.healthrx.co.in/hiring/generateWebhook/JAVA";

        com.usman.bajaj_health_qualifier.GenerateWebhookRequest requestBody = new com.usman.bajaj_health_qualifier.GenerateWebhookRequest(
                "PARIMI VENKATA PAVAN KUMAR",
                "REG22BCE8932",
                "pavan.22bce8932@vitapstudent.ac.in"
        );

        try {
            ResponseEntity<com.usman.bajaj_health_qualifier.GenerateWebhookResponse> response = restTemplate.postForEntity(
                    url,
                    requestBody,
                    com.usman.bajaj_health_qualifier.GenerateWebhookResponse.class
            );
    ...
    private void submitSolution(String webhookUrl, String accessToken, String finalQuery) {
        ...
        com.usman.bajaj_health_qualifier.SubmitSolutionRequest requestBody = new com.usman.bajaj_health_qualifier.SubmitSolutionRequest(finalQuery);

        HttpEntity<com.usman.bajaj_health_qualifier.SubmitSolutionRequest> requestEntity = new HttpEntity<>(requestBody, headers);
